...
struct ReflyemWidget final : public RE::IMenu {
public:
  ...
  static auto get_actor_value_max(RE::Actor* actor, const RE::ActorValue av) -> float;

  // static auto creator() -> RE::stl::owner<RE::IMenu*> { return new ReflyemWidget(); }
  static auto creator() -> RE::IMenu* { return new ReflyemWidget(); }
